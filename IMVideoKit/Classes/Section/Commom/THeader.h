...
#define TMessageCell_Head_Height 40
...
#define TTextMessageCell_Height_Min (TMessageCell_Head_Size.height)
#define TTextMessageCell_Text_PADDING (130)
...
#define TSystemMessageCell_Text_Width_Max (Screen_Width - 2 * TTextMessageCell_Margin)
...
#define TVoiceMessageCell_Duration_Size CGSizeMake(33, 50)

//text view
#define TTextView_Height (60)
#define TTextView_Button_Size CGSizeMake(30, 30)
#define TTextView_Margin 10
...
#define TTextView_Background_Color  RGBA(246, 246, 246, 1.0)
...
#define TMoreView_Background_Color  RGBA(246, 246, 246, 1.0)
...
#define TConversationController_Background_Color RGBA(249, 249, 250, 1.0)

//message controller
#define TMessageController_Background_Color RGBA(249, 249, 250, 1.0)
#define TMessageController_Header_Height 40

//input controller
#define TInputView_Background_Color RGBA(246, 246, 246, 1.0)

//members controller
#define TGroupMembersController_Background_Color RGBA(249, 249, 250, 1.0)
#define TGroupMembersController_Margin 20
#define TGroupMembersController_Row_Count 5

//info controller
#define TGroupInfoController_Background_Color RGBA(249, 249, 250, 1.0)

//setting controller
#define TSettingController_Background_Color RGBA(249, 249, 250, 1.0)
...
//record
#define Record_Background_Color RGBA(50, 61, 81, 0.9)
#define Record_Background_Size CGSizeMake(Screen_Width * 0.4, Screen_Width * 0.4)
#define Record_Title_Height 30
#define Record_Title_Background_Color RGBA(247, 90, 78, 1.0)
...
#define IMNewMessageNotification @"IMNewMessageNotification"
#define VideoMessageNotification @"VideoMessageNotification"
...
#define SYSTEM_BLACK            RGB(50,61,81)
#define SYSTEM_BLUE             RGB(107,162,255)

#define KEY_WINDOW   [UIApplication sharedApplication].keyWindow
#define Top_Safe_Height        (IPHONE_X_Xr_XMax_Xs ? 44 : 20)
#define Bottom_Safe_Height        (IPHONE_X_Xr_XMax_Xs ? 24 : 0)
