...
#import "THeader.h"
@implementation IMSysMuteCellData
...
- (CGSize)contentSize
{
    CGSize size = [self.content textSizeIn:CGSizeMake([UIScreen mainScreen].bounds.size.width - TMessageCell_Head_Width * 2, MAXFLOAT) font:self.contentFont breakMode:NSLineBreakByWordWrapping align:(NSTextAlignmentCenter)];
    size.height += 10;
    return size;
}
