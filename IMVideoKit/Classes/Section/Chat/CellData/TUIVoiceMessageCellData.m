...
- (instancetype)initWithDirection:(TMsgDirection)direction
{
    ...
    if (self) {
        if (direction == MsgDirectionIncoming) {
            ...
            _voiceImage = [UIImage imageNamed:@"inVoice3"];
            _voiceAnimationImages = [NSArray arrayWithObjects:
                                     [UIImage imageNamed:@"inVoice1"],[UIImage imageNamed:@"inVoice2"],[UIImage imageNamed:@"inVoice3"], nil];
            _voiceTop = [[self class] incommingVoiceTop];
        } else {
            self.cellLayout = [TOutgoingVoiceCellLayout new];
            
            _voiceImage = [UIImage imageNamed:@"outcomeVoice3"];
            _voiceAnimationImages = [NSArray arrayWithObjects:
                                     [UIImage imageNamed:@"outcomeVoice1"],[UIImage imageNamed:@"outcomeVoice2"],[UIImage imageNamed:@"outcomeVoice3"], nil];
