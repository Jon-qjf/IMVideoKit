...
- (void)fillWithData:(TUIVoiceMessageCellData *)data;
{
    ...
    if (data.direction == MsgDirectionIncoming) {
        ...
        self.duration.textColor = [UIColor colorWithRed:74/255.0 green:89/255.0 blue:113/255.0 alpha:1];
...
- (void)layoutSubviews
{
    ...
    if (self.voiceData.direction == MsgDirectionOutgoing) {
         self.bubbleView.mm_flexToRight(0);
        self.duration.mm_left(self.voice.mm_w);
        ...
        self.duration.mm_right(self.voice.mm_w);
